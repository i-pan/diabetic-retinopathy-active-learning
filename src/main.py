...
from skp.controls import training, inference
...
def parse_args():
    ...
    parser.add_argument("--active-learning-strategy", type=str)
    parser.add_argument("--resume", type=str, help="path to directory from which to resume, must end in round{x}")

    parser.add_argument("--device-num", type=str)
...
def main(args):
    ...
    elif args.mode in ["active_learning"]:
        active_learning(cfg, args)
    else:
